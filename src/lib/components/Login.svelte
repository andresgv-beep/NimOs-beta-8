...
<div class="login-screen">
  ...
  <div class="boot-log">
    <div class="line"><span class="ts">[    0.000000]</span> <span class="lvl ok">OK</span> <span>NimOS v0.8.0-alpha initialized</span></div>
  ...
  <div class="login-box">
    ...
    <div class="footer-strip">
      <span class="k">build</span> <span class="v">0.8.0-alpha</span>
      <span class="sep">·</span>
