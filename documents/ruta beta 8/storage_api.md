...
**Implementación**: antes de borrar cualquier directorio bajo `/nimbus/pools/` o relacionado, verificar la presencia del archivo `.nimbus-pool.json` en el directorio raíz.
