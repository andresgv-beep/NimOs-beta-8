  ...
  "pools": [
    {
      ...
      "btrfs_uuid": "8d7e6f5a-...",
      "profile": "raid1",
      "mount_point": "/nimbus/pools/multimedia",
      "role": "data",
...
- El `mount_point` tampoco cambia automáticamente (sigue siendo `/nimbus/pools/<antiguo>`). Cambiarlo es operación aparte que requiere unmount/remount, y de momento no se ofrece.
...
```json
{
  "operation": {
    ...
    "events": [
      ...
      { "timestamp": "2026-05-12T09:15:40Z", "level": "info", "message": "Mounted at /nimbus/pools/multimedia" },
