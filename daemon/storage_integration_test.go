...
func TestStorageIntegrationCreateAndDestroyPool(t *testing.T) {
	...
	// El service hardcodea /nimbus/pools/<name>, así que para el test
	// vamos a usar /nimbus/pools/ realmente
	defer exec.Command("umount", "-l", "/nimbus/pools/integration-test").Run()
	defer os.RemoveAll("/nimbus/pools/integration-test")
...
func TestStorageIntegrationAddRemoveDevice(t *testing.T) {
	...
	defer exec.Command("umount", "-l", "/nimbus/pools/addrm-test").Run()
	defer os.RemoveAll("/nimbus/pools/addrm-test")
